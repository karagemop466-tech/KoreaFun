...
>
> **Current inventory:** 619 numbered sections (594 + the 25 new district entries in [`seoul-districts.md`](seoul-districts.md), added and line-verified Aug 19, 2026) after the core-file rebuild, nearby-city additions, and the Aug 18 re-verification passes (Pass 37 added one official-source Jeonju musical). Counts will change only when unsupported entries are removed or official-source entries are added.
>
...
## 📂 What's in this repo (**619 numbered sections** across 15 city/district files; protocol pass complete)
...
| [`seoul-districts.md`](seoul-districts.md) | **25 numbered activity sections** across **Dongdaemun · Hongdae/Mapo · Itaewon/Yongsan · Gangnam/Seocho** — organized as per-district tables (location · dates · hours · official price · open/closed status), verified Aug 19, 2026 |

### 🗺️ Nearby cities along & adjacent to your Seoul ↔ Busan route (10 cities)

| File | Sections | Transit from Seoul | Best for |
|---|---|---|---|
| [`suwon.md`](suwon.md) | 40 | KTX 30 min south | UNESCO **Hwaseong Fortress** walls, Korean royal ribs, **BeautySum Nov 5–7** |
| [`yongin.md`](yongin.md) | 37 | Subway + Everline 60 min south | **Everland** theme park, Korean Folk Village |
| [`incheon.md`](incheon.md) | 45 | AREX 60 min west | **Incheon Chinatown**, Songdo, ICN area, **Incheon ArtShow Nov 19–22** |
| [`jeonju.md`](jeonju.md) | 38 | KTX 2 hr (via Iksan) southwest | **Hanok Village** + bibimbap; **Gyeonggijeon 정전 closed for restoration through Dec 17** |
| [`daegu.md`](daegu.md) | 38 | KTX 1h 50 min southeast | E-World 83 Tower, Seomun Market, Palgongsan temples |
...
## ⭐ The can't-miss shortlist (if you read nothing else)
...
|---|---|---|---|
| Sat Oct 31 | V-League 2026–27 season opens — **GS Caltex home opener 17:00 at Jangchung Arena (fixtures published Aug 18)** · K League 1 Final rounds begin | All cities / Seoul | ✅ |
...
| Thu–Sat Nov 5–7 | **BeautySum Korea Suwon** (Convention Center 1F) — organizer date; ignore Visit Suwon’s Nov 6–8 listing | Suwon | ✅ |
| Sat Nov 7 | **Busan Fireworks Festival** · Seoul E-Land vs Jeonnam 16:30 · MCR / Jujutsu Kaisen concerts · Suwon FC vs Gyeongnam 14:00 | Busan / Seoul / Incheon / Suwon | ✅ |
...
- ✅ **CONFIRMED** — date officially announced by the organizer/league (as of Aug 4, 2026)
...
Prices are in ₩ (KRW) with approximate USD at **~₩1,400 = $1** (mid-2026 ballpark — check [xe.com](https://www.xe.com) before you fly).
...
Fall 2026 dates are still being finalized. When you see ⏳/👀, set a calendar reminder for **mid-October** and re-check the official link listed in that entry — every TBA item's source is already in this repo (`sources.md`). Want this repo to stay alive? Open a PR with updated dates — the file format is simple markdown + CSV.
