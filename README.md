...
>
> **Current inventory:** 593 numbered sections after the core-file rebuild, nearby-city additions, and the Aug 18 re-verification passes (Pass 36 added one official-source entry each in Suwon, Yongin, and Incheon). Counts will change only when unsupported entries are removed or official-source entries are added.
>
...
## 📂 What's in this repo (**593 numbered sections** across 14 city files; protocol pass complete)
...
| [`jeonju.md`](jeonju.md) | 37 | KTX 2 hr (via Iksan) southwest | **Hanok Village** + bibimbap capital of Korea |
